...
basic_auth_id = System.fetch_env!("CAVEATICA_BASIC_AUTH_ID")
basic_auth_password = System.fetch_env!("CAVEATICA_BASIC_AUTH_PASSWORD")

encoded = Base.encode64("#{basic_auth_id}:#{basic_auth_password}", padding: false)
socket_headers = [{"authorization", "Basic #{encoded}"}]
